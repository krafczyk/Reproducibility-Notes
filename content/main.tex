...
There is some contention about these terms, I believe the biology people use different terms. I need to find a reference for this.
...
\begin{itemize}
\item Popper READ MORE/DO MORE
\item WholeTale READ MORE/DO MORE
\item CodeOcean READ MORE/DO MORE
\end{itemize}
...
\begin{itemize}
\item FRAPpuccino \cite{FRAPpuccino} READ MORE/DO MORE
\item Why-Diff \cite{computational-meta-data} READ MORE/DO MORE
\item YesWorkflow \cite{computational-meta-data} READ MORE/DO MORE
\item NoWorkflow \cite{computational-meta-data} READ MORE/DO MORE
\end{itemize}
...
\begin{itemize}
\item Reproducible-builds.org \cite{reproducible-builds}
\item Sciunits \cite{sciunits}
\end{itemize}
...
\begin{itemize}
\item Computer Physics Communications \cite{computer-physics-communications}
\item DARPA Open Catalog \cite{darpa-open-catalog}
\item DOE Code \cite{doe-code}
\item Mendeley \cite{elsevier-mendeley-computer-physics-communication}
\end{itemize}

\section{Policy Efforts}

\begin{itemize}
\item \textit{Science} efforts to get researchers to publish code and data. (NEEDS REFERENCE)
\item \textit{SC'XY} Conference has programs like the student cluster competition. (NEEDS REFERENCE)
\end{itemize}
...
A great article explaining why most published research findings are false. This article discusses some of the career pressures affecting scientist's decisions.
\end{refdef}
...
A paper which originates the term `really reproducible research'. It's also about the wavelab matlab software collection.
\end{refdef}

\begin{refdef}{claerbout-reproducibility-website}{}
A website by Claerbout himself discussion his history with reproducible research.
\end{refdef}

\begin{refdef}{neuromorphic-chips-webarticle}{}
A website describing neuromorphic chips and how they have applications for deep learning.
\end{refdef}

\begin{refdef}{King95}{replication.pdf}
A nice article V.S. Recommended which details various issues faced by researchers in empirical political sciences to replicate works by other authors.
\end{refdef}

\begin{refdef}{elec-doc-res-new-meaning}{}
The original wavelab article about reproducible research. Lays the groundwork for Claerbout's wavelab plan.
\end{refdef}

\begin{refdef}{doi:10.1109/MCSE.2009.14}{}
Another clarbout article about reproducibility.
\end{refdef}

\begin{refdef}{ThreeDreams}{ThreeDreams.pdf}
An Article by Donoho describing three dream applications of verifiable computational results. Similar to my Three Methods.
\end{refdef}

\begin{refdef}{TranslationOpenMPOpenACC}{TranslationOpenMPOpenACC.pdf}
An article describing how to translate between OpenMP and OpenACC. What is missing, and lessons learned. Not exactly portability.. More like Translation.
\end{refdef}

\begin{refdef}{ProgressIn10Years}{ProgressIn10Years.pdf}
This article contains predictions for where technology and the community will be in 10 years time. Interestingly, it seems like fusion. We're still 10 years away from their predictions.
\end{refdef}

\begin{refdef}{computational-meta-data}{computational-meta-data.pdf}
This describes several workflow and metadata analysis tools for work provenance. Why-Diff, YesWorkflow, NoWorkflow
\end{refdef}

\begin{refdef}{FRAPpuccino}{hotcloud17-paper-han.pdf}
A paper describing the meta-workflow analysis software FRAPpuccino.
\end{refdef}
